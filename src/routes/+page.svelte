...
<div class="flex flex-col justify-center items-stretch gap-8 rounded-lg p-4 max-w-lg mx-auto">
	...
	<div class="flex flex-col justify-center items-stretch gap-2">
		<div class="flex justify-between items-center">
			<label for="steps-range" class="block mb-2 text-xl font-medium">مبلغ الاستثمار المبدئي</label>
	...
	<div class="flex flex-col justify-center items-stretch gap-2">
		<div class="flex justify-between items-center">
			<label for="steps-range" class="block mb-2 text-xl font-medium">نسبة الأرباح السنوية</label>
	...
	<div class="flex flex-col justify-center items-stretch gap-2">
		<div class="flex justify-between items-center">
			<label for="steps-range" class="block mb-2 text-xl font-medium">المبلغ الشهري المضاف</label>
	...
	<div class="flex flex-col justify-center items-stretch gap-2">
		<div class="flex justify-between items-center">
			<label for="steps-range" class="block mb-2 text-xl font-medium">عدد السنوات</label>
